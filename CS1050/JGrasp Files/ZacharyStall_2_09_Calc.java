/* This is a seperat Java class that contains three
   ...
   Methods:
      ...
      Zachary_2_09)Calc(double val1, double val2, double val3) - constructor
...
public class ZacharyStall_2_09_Calc {
   ...
   private double grossPay;      // The gross pay ammount
   private double savingsRate;   // The percentage rate that will be saved
   private double iraRate;       // The perventage rate that will invested
   
   // Establish the keyboard
   // Access the toolkit for formatting
   ...
   public ZacharyStall_2_09_Calc(double val1, double val2, double val3) { 
     ...
     savingsRate = val2;
     iraRate   = val3;
   } // End ZacharyStall_2_09_Calc(double val1, double val2, double val3)
   
   // ****************************************************************
   
   // Get values of grossPay, savingsRate, and iraInvest from the user.
   // This method uses getAmounts method.
   ...
   // Get a single number from the keyboard and check that it is not 
   // zero or negative.
   ...
   // Prints formatted gross pay, savings rate, and IRA rate
   // to the console.
   ...
   // savings rate
   public double calcSavingAmount() {
